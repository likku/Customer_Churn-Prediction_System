    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("btn") != null) {
                ...
                String email_check = admin.Login.getEmailAvailable(emailid);
                if (email_check == "ok") {

                    String psw_check = admin.Login.getPasswordAvailable(emailid, password);
                    if (psw_check == "ok") {

                        session.setAttribute("emailid", emailid);
                        session.setAttribute("tou", "chead");
