 ...
 * @author Bharath
 */
@WebServlet(name = "PMRegAction", urlPatterns = {"/PMRegAction"})
public class PMRegAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("btn") != null) {
                ...
                String heademail = se.getAttribute("emailid").toString();


/*

                String email = emailid;
                String subj = "Customer support system Registration Conform Mail";
                String content = "";

                content += "<style>table,th,td{border:1px solid black;}</style>";
                content += "<h1>FeedbackSystem Login Details</h1>";
                content += "<h2>Press This <a href='http://localhost:8080/FeedbackSystem/pmlogin.jsp'>Link</a> to Login Page !</h2>";
                content += "<html><body>";
...
*/
                    ...
                    String ins = pm.Login.addPMDetails(emailid, name, phno, address, password, tou,heademail);
                    if ("ok".equals(ins)) {


                        RequestDispatcher rd = request.getRequestDispatcher("PMreg.jsp");
