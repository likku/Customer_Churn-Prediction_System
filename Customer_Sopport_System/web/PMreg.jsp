...
<div id="site_content">
    ...
    <div id="content">
       ...
       <%
    if(request.getParameter("tou").equals("productmanager")){
        
        %>
       
        <h2>Product Manager Registration Page</h2>
...
%>
        ...
        <form id="contactForm" action="PMRegAction" method="post">
            
            
            <input type="hidden" name="tou" value="<%=request.getParameter("tou")%>" />
