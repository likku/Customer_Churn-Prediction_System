...
<html>
    ...
    <body>
        <%
         ...
         String UPLOAD_DIRECTORY = "C:/Users/reddys/Desktop/MainProjectCode/Customer_Sopport_System/web/uploads";
...
//if (i == 1) {
            ...
            /*} else {
                    ...
                    request.setAttribute("msg", "Only MP4");
                    rd.forward(request, response);
                }*/
